            ...
            <div class="card-body">
                <form action="{{ route('artikel.update', ['id' => $artikel->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        @if ($artikel->gambar)
                            <div class="preview-container">
                                <img src="{{ asset('media/'.$artikel->gambar) }}" alt="Gambar saat ini" class="preview-image">
                                <button type="button" class="btn btn-danger" id="hapus-gambar">Hapus</button>
                            </div>
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        <input id="isi" type="hidden" name="isi" value="{{ $artikel->isi }}">
                        <trix-editor input="isi"></trix-editor>
                    </div>

                    <button type="submit" class="btn" style="background-color:#729043; color:white;">Simpan</button>
                </form>
            </div>
        </div>
    </div>
