...
<body>
    <header class="bg-light py-3">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h1 class="h3 mb-0">Daftar Pertanyaan Saya</h1>
                </div>
            </div>
        </div>
    </header>
    <main class="container my-4">
        <div class="text-center mb-4">
            <a href="/diskusiP" class="btn btn-success mx-2">Kembali</a>
                ...
                <div class="list-group-item">
                    ...
                    @if(Auth::check() && Auth::user()->id == $diskusi->author->id)
                        <div class="d-flex justify-content-end mb-2">
                            <a href="{{ route('diskusi.edit', $diskusi->id) }}" class="btn" style="background-color: #729043; color: white;">Edit</a>
                        </div>
                    @endif
                </div>
            </div>
