...
<body>
    <main class="container my-4 flex-grow-1">       
        ...
        <div class="list-group mb-4">
            <div class="list-group-item">
                <div class="d-flex justify-content-between">
                    ...
                    @if(Auth::check() && Auth::user()->id === $diskusi->author->id)
                        <div>
                            <i class="fas fa-ellipsis-h" data-toggle="modal" data-target="#editModal-{{ $diskusi->id }}"></i>
                        </div>
                    @endif
                </div>
            ...
            <!-- Modal for Editing -->
            <div class="modal fade" id="editModal-{{ $diskusi->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel-{{ $diskusi->id }}" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel-{{ $diskusi->id }}">Edit Diskusi</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <a href="{{ route('diskusi.edit', $diskusi->id) }}" class="btn btn-primary">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
